...
func (s *PolarOrders) Receipt(ctx context.Context, security operations.CustomerPortalOrdersReceiptSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalOrdersReceiptResponse, error) {
	request := operations.CustomerPortalOrdersReceiptRequest{
		ID: id,
	}
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/customer-portal/orders/{id}/receipt", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.CustomerPortalOrdersReceiptResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.CustomerOrderReceipt
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.CustomerOrderReceipt = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *PolarOrders) ConfirmRetryPayment(ctx context.Context, security operations.CustomerPortalOrdersConfirmRetryPaymentSecurity, id string, customerOrderConfirmPayment components.CustomerOrderConfirmPayment, opts ...operations.Option) (*operations.CustomerPortalOrdersConfirmRetryPaymentResponse, error) {
	...
	case httpRes.StatusCode == 429:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out apierrors.ManualRetryLimitExceeded
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}
