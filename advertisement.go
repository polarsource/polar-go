...
// descending order.
Sorting param.Field[[]AdvertisementListParamsSorting] `query:"sorting"`
}
...
type AdvertisementListParamsSorting string

const (
  AdvertisementListParamsSortingCreatedAt AdvertisementListParamsSorting = "created_at"
  AdvertisementListParamsSorting-CreatedAt AdvertisementListParamsSorting = "-created_at"
  AdvertisementListParamsSortingGrantedAt AdvertisementListParamsSorting = "granted_at"
  AdvertisementListParamsSorting-GrantedAt AdvertisementListParamsSorting = "-granted_at"
  AdvertisementListParamsSortingViews AdvertisementListParamsSorting = "views"
  AdvertisementListParamsSorting-Views AdvertisementListParamsSorting = "-views"
  AdvertisementListParamsSortingClicks AdvertisementListParamsSorting = "clicks"
  AdvertisementListParamsSorting-Clicks AdvertisementListParamsSorting = "-clicks"
)

func (r AdvertisementListParamsSorting) IsKnown() (bool) {
  switch r {
  case AdvertisementListParamsSortingCreatedAt, AdvertisementListParamsSorting-CreatedAt, AdvertisementListParamsSortingGrantedAt, AdvertisementListParamsSorting-GrantedAt, AdvertisementListParamsSortingViews, AdvertisementListParamsSorting-Views, AdvertisementListParamsSortingClicks, AdvertisementListParamsSorting-Clicks:
      return true
  }
  return false
}
