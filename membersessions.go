...
func newMemberSessions(rootSDK *Polar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *MemberSessions {
...
func (s *MemberSessions) Create(ctx context.Context, request components.MemberSessionCreate, opts ...operations.Option) (*operations.MemberSessionsCreateResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/member-sessions/")
	if err != nil {
	...
	res := &operations.MemberSessionsCreateResponse{
	...
	case httpRes.StatusCode == 201:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.MemberSession
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.MemberSession = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
