...
func (s *Seats) AssignSeat(ctx context.Context, request components.CustomerSeatAssign, security operations.CustomerPortalSeatsAssignSeatSecurity, opts ...operations.Option) (*operations.CustomerPortalSeatsAssignSeatResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionRetries,
		operations.SupportedOptionTimeout,
