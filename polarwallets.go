...
type PolarWallets struct {
	rootSDK          *Polar
	sdkConfiguration config.SDKConfiguration
	hooks            *hooks.Hooks
}

func newPolarWallets(rootSDK *Polar, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *PolarWallets {
	return &PolarWallets{
		rootSDK:          rootSDK,
...
func (s *PolarWallets) List(ctx context.Context, security operations.CustomerPortalWalletsListSecurity, page *int64, limit *int64, sorting []components.CustomerWalletSortProperty, opts ...operations.Option) (*operations.CustomerPortalWalletsListResponse, error) {
...
//
// **Scopes**: `customer_portal:read` `customer_portal:write`
func (s *PolarWallets) Get(ctx context.Context, security operations.CustomerPortalWalletsGetSecurity, id string, opts ...operations.Option) (*operations.CustomerPortalWalletsGetResponse, error) {
