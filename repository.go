...
// descending order.
Sorting param.Field[[]RepositoryListParamsSorting] `query:"sorting"`
}
...
type RepositoryListParamsSorting string

const (
  RepositoryListParamsSortingCreatedAt RepositoryListParamsSorting = "created_at"
  RepositoryListParamsSorting-CreatedAt RepositoryListParamsSorting = "-created_at"
  RepositoryListParamsSortingName RepositoryListParamsSorting = "name"
  RepositoryListParamsSorting-Name RepositoryListParamsSorting = "-name"
  RepositoryListParamsSortingStars RepositoryListParamsSorting = "stars"
  RepositoryListParamsSorting-Stars RepositoryListParamsSorting = "-stars"
)

func (r RepositoryListParamsSorting) IsKnown() (bool) {
  switch r {
  case RepositoryListParamsSortingCreatedAt, RepositoryListParamsSorting-CreatedAt, RepositoryListParamsSortingName, RepositoryListParamsSorting-Name, RepositoryListParamsSortingStars, RepositoryListParamsSorting-Stars:
      return true
  }
  return false
}
