...
func TestUserSubscriptionNewWithOptionalParams(t *testing.T) {
	...
	_, err := client.Users.Subscriptions.New(context.TODO(), polar.UserSubscriptionNewParams{
		ProductID:     polar.F("product_id"),
		CustomerEmail: polar.F("dev@stainlessapi.com"),
	})
	if err != nil {
...
func TestUserSubscriptionGet(t *testing.T) {
	...
	_, err := client.Users.Subscriptions.Get(context.TODO(), "id")
	if err != nil {
		var apierr *polar.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
...
func TestUserSubscriptionUpdate(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Users.Subscriptions.Update(
		context.TODO(),
		"id",
		polar.UserSubscriptionUpdateParams{
...
func TestUserSubscriptionListWithOptionalParams(t *testing.T) {
	baseURL := "http://localhost:4010"
	if envURL, ok := os.LookupEnv("TEST_API_BASE_URL"); ok {
		baseURL = envURL
	}
	...
	_, err := client.Users.Subscriptions.List(context.TODO(), polar.UserSubscriptionListParams{
		Active:         polar.F(true),
		Limit:          polar.F(int64(1)),
		OrganizationID: polar.F[polar.UserSubscriptionListParamsOrganizationIDUnion](shared.UnionString("string")),
...
func TestUserSubscriptionDelete(t *testing.T) {
	...
	_, err := client.Users.Subscriptions.Delete(context.TODO(), "id")
	if err != nil {
		var apierr *polar.Error
		if errors.As(err, &apierr) {
			t.Log(string(apierr.DumpRequest(true)))
