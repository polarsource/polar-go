...
<a href="https://pkg.go.dev/github.com/stainless-sdks/polar-go"><img src="https://pkg.go.dev/badge/github.com/stainless-sdks/polar-go.svg" alt="Go Reference"></a>
...
```go
import (
	"github.com/stainless-sdks/polar-go" // imported as polar
)
```
...
```sh
go get -u 'github.com/stainless-sdks/polar-go@v0.0.1-alpha.0'
```
...
See the [full list of request options](https://pkg.go.dev/github.com/stainless-sdks/polar-go/option).
...
`*polar.Error`. This contains the `StatusCode`, `*http.Request`, and
...
We also provide a helper `polar.FileParam(reader io.Reader, filename string, contentType string)`
...
We are keen for your feedback; please open an [issue](https://www.github.com/stainless-sdks/polar-go/issues) with questions, bugs, or suggestions.
