...
func (c *CustomerOrderSubscription) GetRecurringInterval() RecurringInterval {
	if c == nil {
...
func (c *CustomerOrderSubscription) GetCurrentMeterPeriodStart() *time.Time {
	if c == nil {
		return nil
	}
...
func (c *CustomerOrderSubscription) GetCurrentMeterPeriodEnd() *time.Time {
	if c == nil {
		return nil
	}
...
func (c *CustomerOrderSubscription) GetPastDueAt() *time.Time {
	if c == nil {
		return nil
	}
	return c.PastDueAt
...
func (c *CustomerOrderSubscription) GetPauseAtPeriodEnd() bool {
	if c == nil {
		return false
	}
...
func (c *CustomerOrderSubscription) GetPausedAt() *time.Time {
	if c == nil {
		return nil
	}
	return c.PausedAt
...
func (c *CustomerOrderSubscription) GetResumesAt() *time.Time {
	if c == nil {
		return nil
	}
	return c.ResumesAt
