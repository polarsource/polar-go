...
func (c *CustomerStateIndividual) UnmarshalJSON(data []byte) error {
	if err := utils.UnmarshalJSON(data, &c, "", false, []string{"id", "created_at", "metadata", "email", "email_verified", "type", "organization_id", "active_subscriptions", "granted_benefits", "active_meters"}); err != nil {
		return err
	}
	return nil
}
...
func (c *CustomerStateIndividual) GetBillingName() *string {
	if c == nil {
		return nil
	}
...
func (c *CustomerStateIndividual) GetDefaultPaymentMethodID() *string {
	if c == nil {
		return nil
	}
