...
func (c *CheckoutLinkProduct) GetRecurringInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CheckoutLinkProduct) GetMeterInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CheckoutLinkProduct) GetMeterIntervalCount() *int64 {
	if c == nil {
		return nil
	}
