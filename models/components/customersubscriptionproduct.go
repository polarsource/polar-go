...
func (c *CustomerSubscriptionProduct) GetRecurringInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CustomerSubscriptionProduct) GetMeterInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CustomerSubscriptionProduct) GetMeterIntervalCount() *int64 {
	if c == nil {
		return nil
	}
