...
func (c *CustomerOrderProduct) GetRecurringInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CustomerOrderProduct) GetMeterInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CustomerOrderProduct) GetMeterIntervalCount() *int64 {
	if c == nil {
		return nil
	}
