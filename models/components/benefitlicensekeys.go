...
func (b *BenefitLicenseKeys) GetIsDeleted() bool {
	if b == nil {
		return false
	}
	return b.IsDeleted
...
func (b *BenefitLicenseKeys) GetVisibility() BenefitVisibility {
	if b == nil {
...
func (b *BenefitLicenseKeys) GetVisibilityConfigurable() bool {
	if b == nil {
		return false
	}
