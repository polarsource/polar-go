...
func (c *CheckoutProduct) GetRecurringInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CheckoutProduct) GetMeterInterval() *RecurringInterval {
	if c == nil {
		return nil
	}
...
func (c *CheckoutProduct) GetMeterIntervalCount() *int64 {
	if c == nil {
		return nil
	}
