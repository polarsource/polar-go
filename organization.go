...
// descending order.
Sorting param.Field[[]OrganizationListParamsSorting] `query:"sorting"`
}
...
type OrganizationListParamsSorting string

const (
  OrganizationListParamsSortingCreatedAt OrganizationListParamsSorting = "created_at"
  OrganizationListParamsSorting-CreatedAt OrganizationListParamsSorting = "-created_at"
  OrganizationListParamsSortingName OrganizationListParamsSorting = "name"
  OrganizationListParamsSorting-Name OrganizationListParamsSorting = "-name"
)

func (r OrganizationListParamsSorting) IsKnown() (bool) {
  switch r {
  case OrganizationListParamsSortingCreatedAt, OrganizationListParamsSorting-CreatedAt, OrganizationListParamsSortingName, OrganizationListParamsSorting-Name:
      return true
  }
  return false
}
