...
func TestProductBenefitUpdate(t *testing.T) {
	...
	_, err := client.Products.Benefits.Update(
		context.TODO(),
		"id",
		polar.ProductBenefitUpdateParams{
			Benefits: polar.F([]string{"string", "string", "string"}),
		},
	)
	if err != nil {
